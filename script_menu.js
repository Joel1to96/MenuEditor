...
const firebaseConfig = {
  ...
  function createMenuItemElement(item, id) {
    ...
    // Nuevo elemento para la descripción
    ...
    menuItem.appendChild(description); // Agregar la descripción aquí
  ...
  async function addNewArticle() {
      const newArticle = {
          ...
          Descripción: document.getElementById('article-description').value || '',
      };
  ...
  function showEditForm(item, id) {
      ...
      document.getElementById('article-description').value = item.Descripción || '';
